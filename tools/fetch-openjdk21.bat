...
set URL=https://builds.shipilev.net/openjdk-jdk21/openjdk-jdk21-windows-x86_64-server.zip

echo [muisca] Creating cache directory...
if not exist "%ROOT_DIR%\.cache" mkdir "%ROOT_DIR%\.cache"

echo [muisca] Downloading OpenJDK 21 from %URL%
...
echo [muisca] JDK 21 extracted to %JDK_DIR%
echo.
