...
public enum EnemyArchetype {
    CENIZA_ACOLYTE("Acolito Ceniza", CombatStats.enemyBaseline(12f, 14f, 16f, 6f, 10f),
            new String[]{"ember_burst", "magma_wave"}, new TalentId[]{TalentId.CENIZA_DISCIPLINE},
            220f, 120f, 90f),
    ...
    CENIZA_REVENANT("Apóstol de Ceniza", CombatStats.enemyBaseline(20f, 16f, 18f, 10f, 16f),
            new String[]{"cinder_chain", "ashen_nova"}, new TalentId[]{TalentId.CENIZA_PYRE},
            240f, 110f, 95f),
    WARDEN_OF_UNITY("Guardia del Vínculo", CombatStats.enemyBaseline(28f, 18f, 22f, 16f, 20f),
            new String[]{"ashen_nova", "oath_shatter", "magma_wave"}, new TalentId[]{TalentId.VANGUARD_TRAINING, TalentId.JURAMENTO_ANCHOR},
            260f, 130f, 70f);
